...
# tell application "Firefox Developer Edition" to activate # will raise all windows
do shell script "open -a Firefox\\ Developer\\ Edition" # will raise frontmost window only
