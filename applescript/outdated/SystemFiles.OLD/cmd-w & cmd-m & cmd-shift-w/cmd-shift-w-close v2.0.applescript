...
tell application "System Events"
	# check if weird window that dissapears on switch (eg: "Colors" ((cmd+shift+c) in many apps like Stickies/Script Editor))
	tell process tarAppPName
		if value of attribute "AXSubrole" of window 1 is equal to "AXFloatingWindow"
